...
with open("Data/"+config.cable_number+"/Impedence_List.csv", "a") as Ana2:
    Ana2.write("Cable Number,Length,Type, Parameter, M1CMD (Normal),M1CMD (2-5), M1D0 (Normal), M1D0 (2-5), M1D1(Normal), M1D1 (2-5), M2CMD (Normal),M2CMD (2-5), M2D0 (Normal), M2D0 (2-5), M2D1(Normal), M2D1 (2-5),\n")
    Ana2.close()
